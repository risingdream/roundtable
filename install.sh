...
echo ""
echo "Usage:"
echo "  /rt-roundtable vc [topic]            Thiel + Munger + Taleb + Horowitz debate"
echo "  /rt-roundtable investors [topic]     Buffett + Marks + Lynch + Dalio + PTJ + Soros debate"
...
echo "  /rt-roundtable all [topic]           Representative 6 across all categories"
